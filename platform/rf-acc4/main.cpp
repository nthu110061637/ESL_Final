...
public:
	...
	addr_t RandomForest0_start_addr = 0x73000000;
 	addr_t RandomForest0_size = 0x01000000;
 	addr_t RandomForest0_end_addr = RandomForest0_start_addr + RandomForest0_size - 1;
	addr_t RandomForest1_start_addr = 0x74000000;
 	addr_t RandomForest1_size = 0x01000000;
 	addr_t RandomForest1_end_addr = RandomForest1_start_addr + RandomForest1_size - 1;
	addr_t RandomForest2_start_addr = 0x75000000;
 	addr_t RandomForest2_size = 0x01000000;
 	addr_t RandomForest2_end_addr = RandomForest2_start_addr + RandomForest2_size - 1;
	addr_t RandomForest3_start_addr = 0x76000000;
 	addr_t RandomForest3_size = 0x01000000;
 	addr_t RandomForest3_end_addr = RandomForest3_start_addr + RandomForest3_size - 1;
	...
	void parse(int argc, char **argv) override {
		...
		assert((mem_end_addr < clint_start_addr || mem_start_addr > RandomForest3_end_addr) &&
...
int sc_main(int argc, char **argv) {
	...
	RandomForest random_forest2("random_forest2");
	RandomForest random_forest3("random_forest3");
	...
	bus.ports[12] = new PortMapping(opt.RandomForest0_start_addr, opt.RandomForest0_end_addr);
	bus.ports[13] = new PortMapping(opt.RandomForest1_start_addr, opt.RandomForest1_end_addr);
	bus.ports[14] = new PortMapping(opt.RandomForest2_start_addr, opt.RandomForest2_end_addr);
	bus.ports[15] = new PortMapping(opt.RandomForest3_start_addr, opt.RandomForest3_end_addr);
	// connect TLM sockets
	...
	bus.isocks[12].bind(random_forest0.tsock);
	bus.isocks[13].bind(random_forest1.tsock);
	bus.isocks[14].bind(random_forest2.tsock);
	bus.isocks[15].bind(random_forest3.tsock);

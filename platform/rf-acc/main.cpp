...
public:
	...
	addr_t RandomForest_start_addr = 0x73000000;
 	addr_t RandomForest_size = 0x01000000;
 	addr_t RandomForest_end_addr = RandomForest_start_addr + RandomForest_size - 1;
	...
	void parse(int argc, char **argv) override {
		...
		assert((mem_end_addr < clint_start_addr || mem_start_addr > RandomForest_end_addr) &&
...
int sc_main(int argc, char **argv) {
	...
	bus.ports[12] = new PortMapping(opt.RandomForest_start_addr, opt.RandomForest_end_addr);
	...
	bus.isocks[12].bind(random_forest.tsock);
